...
struct TabItem: View {
    ...
    @State private var isRenameModalPresented = false
    ...
    var body: some View {
        ...
        .sheet(isPresented: $isRenameModalPresented) {
            RenameTabModal(tab: tab, isPresented: $isRenameModalPresented)
    ...
    private var tabTitle: some View {
        Text(tab.displayTitle)
            ...
            .onTapGesture {
                // If the tab is not selected, select it first instead of trying to rename.
                // Once selected, a subsequent tap on the active tab title can be used to rename.
                if !isSelected {
                    onTap()
                } else {
                    isRenameModalPresented = true
                }
            }
    }
    ...
    private var contextMenuItems: some View {
        ...
        Button(action: {
            ...
            Label(
                tab.customName != nil ? "Rename Tab..." : "Rename Tab...",
                systemImage: "pencil"
            )
        }

...
enum SettingsTab: Hashable {
    case general, spaces, privacySecurity, shortcuts, searchEngines, passwords, extensions
...
struct SettingsContentView: View {
    ...
    var body: some View {
        ...
        .padding(0)
        .controlSize(.regular)
        .onReceive(NotificationCenter.default.publisher(for: NSNotification.Name("selectExtensionsTab"))) { _ in
